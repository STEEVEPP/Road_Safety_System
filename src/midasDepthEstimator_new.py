...
class midasDepthEstimator():
	...
	def initializeModel(self):
		#modelPath = '/home/kids/.cache/kagglehub/models/intel/midas/tfLite/v2-1-small-lite/1/Midas-V2-Quantized.tflite'
		#modelPath = '/home/kids/.cache/kagglehub/models/intel/midas/tfLite/v2-1-small-lite/1/model.tflite'
		#modelPath = '/home/kids/.cache/kagglehub/models/intel/midas/tfLite/v2-1-small-lite/1/1.tflite'
		#modelPath = '/home/kids/Documents/midas_new/tflite_from_saved_model/model_integer_quant.tflite'
		#modelPath = '/home/kids/Documents/midas_new/tflite_from_saved_model/model_weight_quant.tflite'
		#modelPath = '/home/kids/Documents/midas_new/tflite_from_saved_model/model_full_integer_quant.tflite'
		modelPath = '../models/MiDas/model_integer_quant.tflite'
	...
	def estimateDepth(self, image):
		...
		colorizedDisparity_GRAY = cv2.cvtColor(colorizedDisparity, cv2.COLOR_BGR2GRAY)
		
		# Update fps calculator
		self.updateFps()

		return colorizedDisparity, colorizedDisparity_GRAY
	...
	def prepareInputForInference(self, image):
		...
		#img_input = (img_input * 127.5 + 127.5).astype(np.int8)
